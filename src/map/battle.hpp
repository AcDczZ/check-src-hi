...
// eAthena additions
	...
	int refine_event; // chance <= to show rare drops global announces
	int refine_eventpercent; // chance <= to show rare drops global announces
	int refine_eventzeny; // chance <= to show rare drops global announces
	...
	int feature_autoattack_move;
	int feature_autoattack_movetype;
	int feature_autoattack_skilldelay;
	...
	int announce_when_mvp_spawn_dead;
	int set_announce_color;
	
	int sell_piece_cap;
	int sell_piece_cap_card;
